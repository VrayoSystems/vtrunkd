...
echo "NTP sync..."
ssh user@cli-32 "sudo ntpdate 0.ubuntu.pool.ntp.org"
ssh user@srv-32 "sudo ntpdate 0.ubuntu.pool.ntp.org"
...
grep 'select_devread_send() frame' /tmp/syslog-1_srv$1 > /tmp/syslog-1_srv$1_select_devread_send
grep 'select_devread_send() frame' /tmp/syslog-2_srv$1 > /tmp/syslog-2_srv$1_select_devread_send
