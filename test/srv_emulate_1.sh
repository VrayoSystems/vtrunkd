...
tc class add dev eth1 parent 1:1 classid 1:12 htb rate 20mbit ceil 20mbit burst 200kb cburst 200kb
tc qdisc add dev eth1 parent 1:12 netem delay 60ms 10ms 10%
...
tc class add dev eth2 parent 1:1 classid 1:12 htb rate 7mbit ceil 7mbit
tc qdisc add dev eth2 parent 1:12 netem delay 100ms 50ms 10%
...
# eth3
echo "eth3 - bad 3g/cdma:"
tc qdisc del dev eth3 root
#tc qdisc del dev eth3 parent
tc qdisc add dev eth3 root handle 1: htb default 12
tc class add dev eth3 parent 1:1 classid 1:12 htb rate 256kbit ceil 256kbit
tc qdisc add dev eth3 parent 1:12 netem delay 300ms 200ms 10%
