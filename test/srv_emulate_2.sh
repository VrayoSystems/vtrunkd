...
tc class add dev eth1 parent 1:1 classid 1:12 htb rate 880kbit ceil 880kbit
tc qdisc add dev eth1 parent 1:12 netem delay 150ms 50ms 30%
...
tc class add dev eth2 parent 1:1 classid 1:12 htb rate 110kbit ceil 110kbit
tc qdisc add dev eth2 parent 1:12 netem delay 170ms 70ms 50%
