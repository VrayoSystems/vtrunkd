...
tc class add dev eth1 parent 1:1 classid 1:12 htb rate 110kbit ceil 110kbit
...
tc class add dev eth2 parent 1:1 classid 1:12 htb rate 880kbit ceil 880kbit
