...
tc class add dev eth1 parent 1:1 classid 1:12 htb rate 4000kbit ceil 4000kbit
tc qdisc add dev eth1 parent 1:12 netem delay 200ms 50ms 50%
...
tc class add dev eth2 parent 1:1 classid 1:12 htb rate 2000kbit ceil 2000kbit
