...
# eth2
echo "eth2 : dead 3g/cdma"
tc qdisc del dev eth2 root
tc qdisc add dev eth2 root handle 1: htb default 12
tc class add dev eth2 parent 1:1 classid 1:12 htb rate 30kbit ceil 30kbit
tc qdisc add dev eth2 parent 1:12 netem delay 1000ms 500ms 10%
