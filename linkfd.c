...
#ifdef JSON
    vtun_syslog(LOG_INFO,"\"{\"name\":\"%s\",\"s_q_lim\":0,\"s_q\":0,\"s_q_min\":0,\"s_q_max\":0,\"rtt\":0,\"my_rtt\":0,\"cwnd\":0,\"isl\":0,\"r_buf_len\":0,\"upload\":0,\"hold_mode\":0,\"ACS\":0,\"R_MODE\":3,\"buf_len\":0, \"s_e\":0, \"s_r_m\":0, \"s_r\":0, \"a_r_f\":1}", lfd_host->host);
#endif
...
//        usleep(100); // todo need to tune; Is it necessary? I don't know
        ...
        if (timercmp_result || ag_switch_flag) {
            ...
            if (timercmp(&tv_tmp_tmp_tmp, &((struct timeval) {0, 500000}), >=)) {
                ...
                sem_post(&(shm_conn_info->AG_flags_sem));
                vtun_syslog(LOG_INFO,
                        "{\"name\":\"%s\",\"s_q_lim\":%i,\"s_q\":%u,\"s_q_min\":%u,\"s_q_max\":%u,\"rtt\":%f,\"my_rtt\":%i,\"cwnd\":%u,\"isl\":%i,\"r_buf_len\":%i,\"upload\":%i,\"hold_mode\":%i,\"ACS\":%u,\"R_MODE\":%i,\"buf_len\":%i, \"s_e\":%u, \"s_r_m\":%u, \"s_r\":%u, \"a_r_f\":%u}",
                        ...
                        shm_conn_info->stats[info.process_num].speed_chan_data[my_max_send_q_chan_num].up_current_speed,
                        hold_mode, ACK_coming_speed_avg, info.mode, miss_packets_max, info.speed_efficient, info.speed_r_mode, info.speed_resend, AG_ready_flags_tmp);
...
//               if(cur_time.tv_sec - last_tick >= lfd_host->TICK_SECS) {
    ...
    sem_post(&(shm_conn_info->AG_flags_sem));
#ifdef JSON
    vtun_syslog(LOG_INFO,"{\"name\":\"%s\",\"s_q_lim\":0,\"s_q\":0,\"s_q_min\":0,\"s_q_max\":0,\"rtt\":0,\"my_rtt\":0,\"cwnd\":0,\"isl\":0,\"r_buf_len\":0,\"upload\":0,\"hold_mode\":0,\"ACS\":0,\"R_MODE\":2,\"buf_len\":0, \"s_e\":0, \"s_r_m\":0, \"s_r\":0, \"a_r_f\":1}", lfd_host->host);
#endif
